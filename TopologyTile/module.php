...
require_once __DIR__ . "/../libs/TopologyLibrary.inc.php";	
	...
	class TopologyTile extends IPSModule
	{
		...
		public function Create() {
			...
			$this->SetVisualizationType(1);			// Visualisierungstyp auf 1 setzen, da wir HTML anbieten möchten
		...
		public function ApplyChanges() 		{
			...
			//Referenzen Registrieren, das sind die Werte die zwischen core und Visiu ausgetauscht werden
			$ids = [
		...
		public function GetVisualizationTile() {
            ...
            $module = file_get_contents(__DIR__ . '/weathershow.html');
